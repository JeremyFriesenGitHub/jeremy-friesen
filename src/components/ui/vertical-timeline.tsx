  ...
  return (
    <>
      <VerticalTimeline className="gap-8 p-6">
        ...
        >
          <span className="vertical-timeline-element-title font-bold text-white">
            Client Management Analyst
          </span>
          <span className="vertical-timeline-element-subtitle font-semibold text-white">
            <br />
            Finance Canada{" "}
          </span>
          <span className="vertical-timeline-element-subtitle text-white">
            <br />
            Ottawa, ON
          </span>
        ...
        >
          <span className="vertical-timeline-element-title font-bold text-white">
            Data Scientist for Complex Systems{" "}
          </span>
          <span className="vertical-timeline-element-subtitle font-semibold text-white">
            <br />
