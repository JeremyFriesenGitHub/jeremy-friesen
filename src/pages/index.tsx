...
const items = [
  {
    ...
    header: (
      <div className="bg-dot-black/[0.3] dark:bg-dot-white/[0.2] flex h-full min-h-[6rem] w-full flex-1 rounded-xl border border-purple-500/30 bg-gradient-to-br from-pink-600 via-fuchsia-700 to-purple-900 text-white shadow-[0_0_20px_#ff00ff80] [mask-image:radial-gradient(ellipse_at_center,white,transparent)]">
        <Image
          src="/test7.png"
          width={300}
          height={300}
          alt="prodly landing page"
          className="w-500 h-500 rounded-r-xl object-cover"
        />
        <Image
          src="/test8.png"
          width={300}
          height={100}
          alt="pomodoro timer"
          className="w-500 h-500 rounded-xl object-cover"
        />
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <LinkPreview url="https://carletonai.github.io/docs/">
        <div className="text-white hover:underline">
          Carleton AI Society docs
        </div>
      </LinkPreview>
    ),
    header: (
      <div className="dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex h-full min-h-[6rem] w-full flex-1 rounded-xl border border-transparent bg-neutral-100 text-black [mask-image:radial-gradient(ellipse_at_center,white,transparent)] dark:border-white/[0.2] dark:bg-black">
        <Image
          src="/test9.png"
          width={300}
          height={300}
  ...
  },
  {
    ...
    description: (
      <LinkPreview url="https://devpost.com/software/cu-tunnels">
        <div className="text-white hover:underline">
          A web app that helps people navigate Carleton&apos;s underground
          tunnel system
        </div>
      </LinkPreview>
    ),
  ...
  },
  {
    ...
    description: (
      <LinkPreview url="https://github.com/JeremyFriesenGitHub/ai-snow-day-predictor">
        <div className="text-white hover:underline">
          An open-source snowday predictor using live data and Aritificial
          Intelligence
        </div>
      </LinkPreview>
    ),
  ...
  return (
    <>
      ...
      <main className="relative flex min-h-screen flex-col">
        {/* Background Layer */}
        <div className="relative inset-0 min-h-screen w-full bg-gradient-to-b from-[#1353B4] via-[#4E5E1C] to-[#1353B4]">
          <Navbar />
          <Boxes />
          ...
          <section id="about" className="p-8 text-center sm:p-16">
            <a href="#about">
              <span className="relative items-center justify-center p-8 text-2xl font-bold text-white underline sm:p-16 sm:text-3xl">
                About
              </span>
            </a>
            <div className="flex flex-col items-center justify-center pt-6">
              ...
              />
              <div className="relative max-w-2xl text-lg text-white sm:text-xl">
                <ul className="list-inside list-disc space-y-6">
                  <p>
                    I&apos;m a third year CS Student at Carleton University
                    who&apos;s:
                  </p>
                  <li>
                    Committed to{" "}
                    <strong>Continuous Learning & Improvement</strong>
                  </li>
                  <li>
                    Passionate about and experienced in{" "}
                    <strong>Data Science/Analysis</strong>,{" "}
                    <strong>Software Development</strong>,{" "}
                    <strong>Cloud & IT Infrastructure</strong>,{" "}
                    <strong>DevSecOps</strong>, and <strong>AI/ML</strong>
                  </li>
                  <li>
                    Always striving to build a solid{" "}
          ...
          <section id="experience" className="p-8 text-center sm:p-16">
            <a href="#experience">
              <span className="relative items-center justify-center p-8 text-2xl font-bold text-white underline sm:p-16 sm:text-3xl">
                Experience
              </span>
          ...
          <section id="projects" className="p-8 text-center sm:p-16">
            <a href="#projects">
              <span className="relative items-center justify-center p-8 text-2xl font-bold text-white underline sm:p-16 sm:text-3xl">
                Projects
              </span>
            </a>
            <BentoGrid className="relative mx-auto max-w-4xl gap-8 p-6 text-white md:auto-rows-[20rem]">
              {items.map((item, i) => (
                <BentoGridItem
                  key={i}
                  title={item.title}
          ...
          <section id="skills" className="p-8 text-center sm:p-16">
            <a href="#skills">
              <span className="relative items-center justify-center p-8 text-2xl font-bold text-white underline sm:p-16 sm:text-3xl">
                Skills
              </span>
